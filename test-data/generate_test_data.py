...
def create_sample_bill():
    ...
    patient_table = Table(
        patient_data, colWidths=[1.5 * inch, 2.2 * inch, 1.5 * inch, 2.3 * inch]
    )
    ...
    service_data = [
        ...
        [
            "04/06/2026",
            "Hospital Room - Semi-private (1 night)",
            "99231",
            "1",
            "$2,800.00",
            "$2,800.00",
    ...
    service_table = Table(
        service_data,
        colWidths=[1 * inch, 2.8 * inch, 0.9 * inch, 0.7 * inch, 1 * inch, 1 * inch],
    )
